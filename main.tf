...
module "openshift_controlplane" {
  ...
  node_type            = "master"
  depends              = [module.prepare_openshift.finished]
  max_bid_price        = var.max_bid_price_controlplane
  ssh_key_id           = var.ssh_key_id_controlplane
  ssh_private_key_path = module.sshkey.ssh_private_key_file
}
...
module "openshift_workers" {
  ...
  node_type            = "worker"
  depends              = [module.prepare_openshift.finished]
  max_bid_price        = var.max_bid_price_compute
  ssh_key_id           = var.ssh_key_id_compute
  ssh_private_key_path = module.sshkey.ssh_private_key_file
}
